...
class _ApiScreenState extends State<ApiScreen> {
  ...
  bool _isUnityEngineReady = false;
  ...
  void onUnityMessage(message) {
    ...
    final msgString = message.toString().trim();

    if (msgString == "READY") {
      setState(() {
        _isUnityEngineReady = true;
      });

      print('AR BRIDGE: Unity native libraries verified. Sending heritage ID...');
