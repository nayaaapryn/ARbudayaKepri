...
class _ARViewScreenState extends State<ARViewScreen> {
  ...
  void _onUnityCreated(UnityWidgetController controller) {
    ...
    // Send the heritage ID across the bi-directional communication bridge to Unity.
    // In Unity, there must be a GameObject named "FlutterBridgeReceiver" with a script
    // implementing a method "OnHeritageReceived" accepting a string parameter.
    try {
